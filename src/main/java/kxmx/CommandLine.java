...
import kxmx.CommandLine.Help.Ansi.IStyle;
import kxmx.CommandLine.Help.Ansi.Style;
import kxmx.CommandLine.Help.Ansi.Text;
import kxmx.CommandLine.Model.*;

import static java.util.Locale.ENGLISH;
import static kxmx.CommandLine.Model.ArgsReflection.abbreviate;
import static kxmx.CommandLine.Help.Column.Overflow.SPAN;
import static kxmx.CommandLine.Help.Column.Overflow.TRUNCATE;
import static kxmx.CommandLine.Help.Column.Overflow.WRAP;
 ...
 * </p><h2>Example</h2>
 * <pre>import static kxmx.CommandLine.*;
 *
...
public class CommandLine {
     ...
     * user object with {@code @Option} and {@code @Parameters}-annotated fields, in which case kxmx automatically
     ...
     * kxmx creates a {@link java.lang.reflect.Proxy Proxy} whose methods return the matched command line values.
     * If the specified command object is a concrete {@code Class}, kxmx delegates to the {@linkplain IFactory factory} to get an instance.
     * </p><p>
     * When the {@link #parse(String...)} method is called, the {@link CommandSpec CommandSpec} object will be
     * initialized based on command line arguments. If the commandSpec is created from an annotated user object, this
     * user object will be initialized based on the command line arguments.</p>
     ...
     * {@code @Option} and {@code @Parameters}-annotated fields, in which case kxmx automatically
     * constructs a {@code CommandSpec} from this user object.
     * </p>
     ...
     * instance of the specified interface. The interface is expected to have annotated getter methods. kxmx will
    ...
    private static List<Object> execute(CommandLine parsed, List<Object> executionResult) {
        ...
        if (command instanceof Runnable) {
            try {
                ...
                executionResult.add(null); // for compatibility with kxmx 2.x
     ...
     * }</pre>
     * <p>
     * From kxmx v2.0, {@code RunLast} is used to implement the {@link #run(Runnable, PrintStream, PrintStream, Help.Ansi, String...) run}
     ...
     * }</pre>
     * <p>
     * kxmx provides some default handlers that allow you to accomplish some common tasks with very little code.
     ...
     * <a href="http://kxmx.info/#_usage_help_with_styles_and_colors">markup for colors and style</a>.
     * @param out the printStream to print to
     * @param ansi whether the usage message should include ANSI escape codes or not
     * @see Command#version()
     ...
     * method with the {@link RunAll} handler or a custom handler.
     * </p><p>
     * From kxmx v2.0, this method prints usage help or version help if {@linkplain #printHelpIfRequested(List, PrintStream, PrintStream, Help.Ansi) requested},
    ...
    /**
     * <p>
     * Annotate fields in your class with {@code @Option} and kxmx will initialize these fields when matching
     * arguments are specified on the command line.
     * </p><p>
     * For example:
     * </p>
     * <pre>
     * import static kxmx.CommandLine.*;
     *
    ...
    public @interface Option {
         ...
         * kxmx supports all of the below styles. The default separator is {@code '='}, but this can be configured.
         * </p><p>
         * <b>*nix</b>
         * </p><p>
         ...
         * </p><p>kxmx supports the POSIX convention that short options can be grouped, with the last option
         ...
         * The <a href="http://kxmx.info/#_printing_help_automatically">convenience methods</a> {@code Commandline.call},
         ...
         * </p><p>
         * If this option is specified on the command line, kxmx will not validate the remaining arguments (so no "missing required
         ...
         * <p>
         * From kxmx 3.2, the usage string may contain variables that are rendered when help is requested.
         ...
         * <p>
         * In many cases kxmx can deduce the number of required parameters from the field's type.
         ...
         * <p>
         * By default kxmx does not expect boolean options (also called "flags" or "switches") to have a parameter.
         ...
         * kxmx uses the field name in fish brackets ({@code '<'} and {@code '>'}) by default. Example:
         * <pre>class Example {
         ...
         * </p><p>
         * kxmx will use the {@link ITypeConverter} that is
         ...
         * but starting from 2.0 kxmx will infer the component type from the generic type's type arguments.
         * For example, for a field of type {@code Map<TimeUnit, Long>} kxmx will know the option parameter
         ...
         * is required for this. For generic types with wildcards, kxmx will take the specified upper or lower bound
         ...
         * <p>Note that kxmx 3.2 allows {@linkplain #description() embedding default values} anywhere in the description that ignores this setting.</p>
    ...
    public @interface Parameters {
         ...
         * Prior to 2.0, the {@code type} attribute was necessary for {@code Collection} and {@code Map} fields,
         * but starting from 2.0 kxmx will infer the component type from the generic type's type arguments.
         * For example, for a field of type {@code Map<TimeUnit, Long>} kxmx will know the positional parameter
         * should be split up in key=value pairs, where the key should be converted to a {@code java.util.concurrent.TimeUnit}
     ...
     * If this annotation is found, kxmx automatically sets {@linkplain CommandLine#setUnmatchedArgumentsAllowed(boolean) unmatchedArgumentsAllowed} to {@code true}.
    ...
    public @interface Command {
         ...
         * specified on the command line, kxmx will not validate the parent arguments (so no "missing required
         ...
         * @return {@code true} if this subcommand is a help command and kxmx should not check for missing required
         ...
         * <p>Note that kxmx 3.2 allows {@linkplain Option#description() embedding default values} anywhere in the
     ...
     * </p>
     * @see kxmx.CommandLine#CommandLine(Object, IFactory)
     * @see #call(Class, IFactory, PrintStream, PrintStream, Help.Ansi, String...)
     * @see #run(Class, IFactory, PrintStream, PrintStream, Help.Ansi, String...)
     * @since 2.2 */
    ...
    /** This class provides a namespace for classes and interfaces that model concepts and attributes of command line interfaces in kxmx.
     * @since 3.0 */
    public static final class Model {
        ...
        public static interface IGetter {
             ...
             * @throws kxmxException if a problem occurred while obtaining the current value
             * @throws Exception internally, kxmx call sites will catch any exceptions thrown from here and rethrow them wrapped in a kxmxException */
        ...
        public static interface ISetter {
             ...
             * @throws kxmxException if a problem occurred while setting the new value
             * @throws Exception internally, kxmx call sites will catch any exceptions thrown from here and rethrow them wrapped in a kxmxException */
         ...
         * <p>
         * kxmx views a command line application as a hierarchy of commands: there is a top-level command (usually the Java
         ...
         * This object model is used by the kxmx command line interpreter and help message generator.
         * </p><p>kxmx can construct a {@code CommandSpec} automatically from classes with {@link Command @Command}, {@link Option @Option} and
        ...
        public static class CommandSpec {
             ...
             * @throws InitializationException if the specified object has no kxmx annotations or has invalid annotations
             */
        ...
        public static class UsageMessageSpec {
            ...
            private static int getSysPropertyWidthOrDefault(int defaultWidth) {
                String userValue = System.getProperty("kxmx.usage.width");
                if (userValue == null) { return defaultWidth; }
                try {
                    int width = Integer.parseInt(userValue);
                    if (width < MINIMUM_USAGE_WIDTH) {
                        new Tracer().warn("Invalid kxmx.usage.width value %d. Using minimum usage width %d.%n", width, MINIMUM_USAGE_WIDTH);
                        return MINIMUM_USAGE_WIDTH;
                    }
                    return width;
                } catch (NumberFormatException ex) {
                    new Tracer().warn("Invalid kxmx.usage.width value '%s'. Using usage width %d.%n", userValue, defaultWidth);
                    return defaultWidth;
                }
            }

            /** Returns the maximum usage help message width. Derived from system property {@code "kxmx.usage.width"}
        ...
        public abstract static class ArgSpec {
            ...
            public <T> T getValue() throws kxmxException {
                try {
                    return getter.get();
                } catch (kxmxException ex) { throw ex;
                } catch (Exception ex) {        throw new kxmxException("Could not get value for " + this + ": " + ex, ex);
                }
            }
            ...
            public <T> T setValue(T newValue) throws kxmxException {
                try {
                    return setter.set(newValue);
                } catch (kxmxException ex) { throw ex;
                } catch (Exception ex) {        throw new kxmxException("Could not set value (" + newValue + ") for " + this + ": " + ex, ex);
                }
            }
         ...
         * </p><p>
         * Before calling the setter, kxmx converts the option parameter value from a String to the option parameter's type.
         * </p>
         * <ul>
         ...
         * </ul>
         * <p>
         * {@code OptionSpec} objects are used by the kxmx command line interpreter and help message generator.
         * kxmx can construct an {@code OptionSpec} automatically from fields and methods with {@link Option @Option}
         ...
         * (In the case of arrays, the array is replaced with a new instance with additional elements.)
         * </p><p>
         * Before calling the setter, kxmx converts the positional parameter value from a String to the parameter's type.
         * </p>
         * <ul>
         ...
         * </ul>
         * <p>
         * {@code PositionalParamSpec} objects are used by the kxmx command line interpreter and help message generator.
         * kxmx can construct a {@code PositionalParamSpec} automatically from fields and methods with {@link Parameters @Parameters}
            ...
            void addAll(String[] unmatched) {
                if (setter != null) {
                    try {
                        ...
                        throw new kxmxException(String.format("Could not invoke setter (%s) with unmatched argument array '%s': %s", setter, Arrays.toString(unmatched), ex), ex);
                    }
                }
                if (getter != null) {
                    try {
                        ...
                        throw new kxmxException(String.format("Could not add unmatched argument array '%s' to collection returned by getter (%s): %s",
        ...
        static class TypedMember {
            ...
            private TypedMember(Field field, Object scope) {
                ...
                if (Proxy.isProxyClass(scope.getClass())) {
                    throw new InitializationException("Invalid kxmx annotation on interface field");
                }
            ...
            private TypedMember(Method method, Object scope) {
                ...
                if (isGetter) {
                    ...
                    if (Proxy.isProxyClass(scope.getClass())) {
                        kxmxInvocationHandler handler = (kxmxInvocationHandler) Proxy.getInvocationHandler(scope);
                        kxmxInvocationHandler.ProxyBinding binding = handler.new ProxyBinding(method);
                        getter = binding; setter = binding;
        ...
        private static class CommandReflection {
                ...
                if (command instanceof Class) {
                    ...
                    try {
                        ...
                        if (cls.isInterface()) {
                            ...
                            instance = Proxy.newProxyInstance(cls.getClassLoader(), new Class[]{cls}, new kxmxInvocationHandler());
                        } else {
                            throw ex;
                        }
                    }
            ...
            private static void validateInjectSpec(TypedMember member) {
                ...
                if (member.getType() != CommandSpec.class) { throw new InitializationException("@kxmx.CommandLine.Spec annotation is only supported on fields of type " + CommandSpec.class.getName()); }
            }
        ...
        private static class FieldBinding implements IGetter, ISetter {
            ...
            public <T> T get() throws kxmxException {
                try {
                    @SuppressWarnings("unchecked") T result = (T) field.get(scope);
                    return result;
                } catch (Exception ex) {
                    throw new kxmxException("Could not get value for field " + field, ex);
                }
            }
            public <T> T set(T value) throws kxmxException {
                try {
                    @SuppressWarnings("unchecked") T result = (T) field.get(scope);
                    field.set(scope, value);
                    return result;
                } catch (Exception ex) {
                    throw new kxmxException("Could not set value for field " + field + " to " + value, ex);
                }
            }
        }
        private static class MethodBinding implements IGetter, ISetter {
            ...
            public <T> T set(T value) throws kxmxException {
                try {
                    ...
                    throw new kxmxException("Could not invoke " + method + " with " + value, ex);
                }
            }
        }
        private static class kxmxInvocationHandler implements InvocationHandler {
    ...
    public static class ParseResult {
        ...
        public static class Builder {
            ...
            public void addError(kxmxException ex) {
    ...
    private class Interpreter {
        ...
        private void maybeThrow(kxmxException ex) throws kxmxException {
...
//                }
    ...
    private static class BuiltIn {
        ...
        static class ISO8601TimeConverter implements ITypeConverter<Object> {
            // Implementation note: use reflection so that kxmx only requires the java.base module in Java 9.
     ...
     * {@link #init(CommandLine, kxmx.CommandLine.Help.Ansi, PrintStream, PrintStream) init} method on commands marked as {@link Command#helpCommand() helpCommand}
     ...
     * the <a href="https://remkop.github.io/kxmx/index.html#_usage_help">Manual</a> for details.</p>
    ...
    public static class Help {
         ...
         * @deprecated use {@link kxmx.CommandLine.Help#Help(kxmx.CommandLine.Model.CommandSpec, kxmx.CommandLine.Help.ColorScheme)}  */
...
//                return result;
        ...
        public static class ColorScheme {
             ...
             *     <li>{@code kxmx.color.commands}</li>
             *     <li>{@code kxmx.color.options}</li>
             *     <li>{@code kxmx.color.parameters}</li>
             *     <li>{@code kxmx.color.optionParams}</li>
            ...
            public ColorScheme applySystemProperties() {
                replace(commandStyles,     System.getProperty("kxmx.color.commands"));
                replace(optionStyles,      System.getProperty("kxmx.color.options"));
                replace(parameterStyles,   System.getProperty("kxmx.color.parameters"));
                replace(optionParamStyles, System.getProperty("kxmx.color.optionParams"));
                return this;
            }
        ...
        /** Creates and returns a new {@link ColorScheme} initialized with kxmx default values: commands are bold,
        ...
        public enum Ansi {
            /** Only emit ANSI escape codes if the platform supports it and system property {@code "kxmx.ansi"}
             ...
             * @return ON: {@code true}, OFF: {@code false}, AUTO: if system property {@code "kxmx.ansi"} is
             *      defined then return its boolean value, otherwise return whether the platform supports ANSI escape codes */
            public boolean enabled() {
                if (this == ON)  { return true; }
                if (this == OFF) { return false; }
                return (System.getProperty("kxmx.ansi") == null ? ansiPossible() : Boolean.getBoolean("kxmx.ansi"));
            }
    ...
    private enum TraceLevel { OFF, WARN, INFO, DEBUG;
        ...
        private String prefix(String msg) { return "[kxmx " + this + "] " + msg; }
        static TraceLevel lookup(String key) { return key == null ? WARN : empty(key) || "true".equalsIgnoreCase(key) ? INFO : valueOf(key); }
    }
    private static class Tracer {
        TraceLevel level = TraceLevel.lookup(System.getProperty("kxmx.trace"));
    ...
    /** Base class of all exceptions thrown by {@code kxmx.CommandLine}.
     * @since 2.0 */
    public static class kxmxException extends RuntimeException {
        private static final long serialVersionUID = -2574128880125050818L;
        public kxmxException(String msg) { super(msg); }
        public kxmxException(String msg, Exception ex) { super(msg, ex); }
    }
    /** Exception indicating a problem during {@code CommandLine} initialization.
     * @since 2.0 */
    public static class InitializationException extends kxmxException {
     ...
     * @since 2.0 */
    public static class ExecutionException extends kxmxException {
    ...
    public static class TypeConversionException extends kxmxException {
    ...
    public static class ParameterException extends kxmxException {
